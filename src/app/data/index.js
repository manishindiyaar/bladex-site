export const navItems = [
  ...
  export const gridItems = [
    ...
    },
    {
      ...
      imgClassName: " img-color-bg",
      titleClassName: "justify-start ",
      img: "bot-svgrepo-com.svg",
      spareImg: "",
    },
    {
      id: 3,
      title: "Our Tech Stack",
      description: "we keep experimenting",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
  ...
  export const workExperience = [
    ...
    },
    {
      id: 3,
      title: "AI Automation",
      desc: "We first analyze your way of working and then build an Agentic workflow which can do all your manual tasks",
      className: "md:col-span-2", // change to md:col-span-2
      thumbnail: "/exp3.svg",
    },
    {
